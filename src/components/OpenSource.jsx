  ...
  return (
    <section className="py-12 sm:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Card className="max-w-4xl mx-auto p-6 sm:p-8 glass-card border-border/50 hover-lift">
          <div className="flex flex-col sm:flex-row items-start gap-4 mb-6">
            <div className="p-4 rounded-lg bg-gradient-to-br from-primary to-accent animate-glow">
              <Heart className="h-8 w-8 text-white" />
            </div>
            <div className="flex-1">
              <h3 className="text-xl sm:text-2xl font-bold mb-2">Google Summer of Code Contributor</h3>
          ...
          <div className="space-y-4 sm:space-y-6 sm:ml-0 lg:ml-20">
            ...
            <div>
              <h4 className="font-semibold text-base sm:text-lg mb-3">Contributions & Impact:</h4>
              <ul className="space-y-3 text-foreground/80 text-sm sm:text-base">
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4 pt-4">
              <div className="text-center p-3 sm:p-4 rounded-lg bg-secondary/50 border border-border/50">
                <GitPullRequest className="h-5 w-5 sm:h-6 sm:w-6 text-primary mx-auto mb-2" />
                <p className="text-xl sm:text-2xl font-bold">15+</p>
                <p className="text-xs sm:text-sm text-muted-foreground">Pull Requests</p>
              </div>
              <div className="text-center p-3 sm:p-4 rounded-lg bg-secondary/50 border border-border/50">
