      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {achievements.map((achievement, index) => (
            <Card
              key={index}
              className="p-6 glass-card border-border/50 hover-lift text-center group"
            >
              <div className="p-4 rounded-full bg-gradient-to-br from-primary to-accent w-fit mx-auto mb-4 group-hover:shadow-[var(--shadow-glow)] transition-shadow">
